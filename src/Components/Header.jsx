        ...
        <header className="bg-[#206138] relative">
            ...
            <div className="flex justify-between items-center h-20 px-4 md:px-8 lg:px-20">
                ...
                <div className="hidden lg:flex items-center space-x-4">
                    ...
                    hover:scale-105 font-bold transition-transform text-sm xl:text-base">
                        Criar Conta
                    </button>
                </div>
                ...
                <div className="lg:hidden bg-[#206138] border-t border-green-400">
                    <nav className="px-4 py-4 space-y-3">
                        ...
                        <div>
                            <button 
                                onClick={toggleDropdown}
                                className="w-full text-left text-white font-bold hover:underline flex items-center justify-between hover:cursor-pointer">
                                Menu
                        ...
                        <div className="pt-4 space-y-3 border-t border-green-400">
                            ...
                            font-bold hover:scale-110 transition-transform cursor-pointer">
                                Criar Conta
                            </button>
                        </div>
                    </nav>
