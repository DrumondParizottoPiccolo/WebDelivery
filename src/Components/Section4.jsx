...
function Section4() {
  ...
  return (
    <div className='w-full h-90 bg-red-50 flex justify-center items-center flex-col gap-4'>
        ...
        <div className='flex-row flex gap-4 w-4/5 overflow-hidden border-2 border-gray-300 p-4 rounded-lg h-auto justify-center items-center'>
